...
description: Add or modify a NestJS controller (HTTP endpoints, DTOs, pipes, guards). Use when exposing a new route, accepting a request body, adding query params, or wiring authentication onto a controller.
---
