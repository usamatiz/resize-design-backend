---
name: nest-typeorm
description: Add or modify TypeORM entities, repositories, and DB queries in this NestJS app. Use when creating/changing database entities, adding a persisted field, or writing a repository query.
---
