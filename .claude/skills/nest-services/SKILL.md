---
name: nest-services
description: Write or modify the business-logic (orchestrator) service in a NestJS feature module. Invoke when the user asks to add a workflow, enforce a rule, coordinate DB + external calls, or handle transactions.
---
