---
name: nest-supabase
description: Use Supabase Auth, Storage, or Realtime from this NestJS app. Invoke when the user asks to sign users in, upload files, subscribe to changes, or talk to Supabase over HTTP (not raw Postgres).
---
