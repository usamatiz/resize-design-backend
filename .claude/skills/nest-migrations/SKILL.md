...
description: Create, generate, or run TypeORM migrations in this NestJS app. Invoke when the user asks to change the DB schema, add a table/column/index, backfill data, or troubleshoot a broken migration.
---
