...
description: Decide how to split a NestJS feature's services when responsibilities differ (persistence, external APIs, business logic). Invoke when a service is growing, when a class touches both DB and an external client, or when the user asks how to structure a new feature.
---
